        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <motion.a
                href="https://github.com/me-safwan-07"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
              ...
              <motion.a
                href="https://www.linkedin.com/in/muhammedsafwan07/"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/events" className="text-gray-600 hover:text-brand">Events</Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-600 hover:text-brand">About</Link>
              </li>
            </ul>
          </div>
